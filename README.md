...
1. MUST be mentioned in either the `THIRD_PARTY_NOTICE` file or the `LICENSE` file (preferably the `THIRD_PARTY_NOTICE` file).
3. SHOULD be mentioned in the `README` file.
code.
