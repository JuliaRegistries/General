...
| Workflow                    | Status                                                                                                                                                                                                                                 |
|:--------------------------- |:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AutoMerge                   | [![AutoMerge status](https://github.com/JuliaRegistries/General/actions/workflows/automerge.yml/badge.svg "AutoMerge status")](https://github.com/JuliaRegistries/General/actions/workflows/automerge.yml)                             |
| Continuous Integration (CI) | [![Continuous Integration (CI) status](https://github.com/JuliaRegistries/General/actions/workflows/ci.yml/badge.svg "Continuous Integration (CI) status")](https://github.com/JuliaRegistries/General/actions/workflows/ci.yml)       |
| TagBot Triggers             | [![TagBot Triggers status](https://github.com/JuliaRegistries/General/actions/workflows/TagBotTriggers.yml/badge.svg "TagBot Triggers status")](https://github.com/JuliaRegistries/General/actions/workflows/TagBotTriggers.yml)       |
| Update Manifests            | [![Update Manifests status](https://github.com/JuliaRegistries/General/actions/workflows/update_manifests.yml/badge.svg "Update Manifests status")](https://github.com/JuliaRegistries/General/actions/workflows/update_manifests.yml) |

General is the default Julia package registry. Package registries are used by Julia's
package manager [Pkg.jl](https://julialang.github.io/Pkg.jl/v1/) and includes information about packages such as versions,
...
[Registrator.jl](https://github.com/JuliaRegistries/Registrator.jl) to automate this process. Registrator can either be used as a
[GitHub App](https://github.com/JuliaRegistries/Registrator.jl#via-the-github-app) or through a [web interface](https://github.com/JuliaRegistries/Registrator.jl#via-the-web-interface), as decribed in
the [Registrator README](https://github.com/JuliaRegistries/Registrator.jl/blob/master/README.md).
...
It is ***highly recommended*** to also use [TagBot](https://github.com/JuliaRegistries/TagBot), which automatically tags a release in your
...
Only pull requests that are opened by [Registrator](https://github.com/JuliaRegistries/Registrator.jl) are candidates
for automatic merging.

The full list of AutoMerge guidelines is available in the
[RegistryCI documentation](https://juliaregistries.github.io/RegistryCI.jl/stable/guidelines/).

Please report issues with automatic merging to the [RegistryCI repo](https://github.com/JuliaRegistries/RegistryCI.jl).
...
the [package naming guidelines](https://julialang.github.io/Pkg.jl/v1/creating-packages/#Package-naming-guidelines-1).
...
because it does not follow the [naming guidelines](https://julialang.github.io/Pkg.jl/v1/creating-packages/#Package-naming-guidelines-1). If you think that
...
`OldName.jl` to `NewName.jl` is reasonably straightforward:
  ...
  - [Rename the GitHub repository](https://help.github.com/en/github/administering-a-repository/renaming-a-repository) to `NewName.jl`
...
#### How do I transfer a package to an organization or another user?
  ...
  - Use the [GitHub transfer option](https://help.github.com/en/github/administering-a-repository/transferring-a-repository) in the settings.
